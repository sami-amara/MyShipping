...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20260607165804_AddAccountAuditLogAndDeactivation")]
    partial class AddAccountAuditLogAndDeactivation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DataAccessLayer.Models.AccountAuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("DataAccessLayer.UserModels.ApplicationUser", b =>
                {
                    ...
                    b.Property<Guid?>("DefaultCarrierId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultCityId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultCountryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultShippingPackageId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("DefaultShippingTypeId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<bool>("NotifyShipmentStatusUpdates")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Domains.TbPaymentTransaction", b =>
                {
                    ...
                    b.HasIndex("IdempotencyKey")
                        .HasDatabaseName("IX_TbPaymentTransaction_IdempotencyKey");

                    b.HasIndex("PaymentMethodId");

                    b.HasIndex("ProviderEventId")
                        .HasDatabaseName("IX_TbPaymentTransaction_ProviderEventId");
            ...
            modelBuilder.Entity("Domains.TbPaymentWebhookEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.ToTable("TbPaymentWebhookEvents", (string)null);
                });
            ...
            modelBuilder.Entity("DataAccessLayer.Models.AccountAuditLog", b =>
                {
                    b.HasOne("DataAccessLayer.UserModels.ApplicationUser", "User")
                        .WithMany("AuditLogs")
