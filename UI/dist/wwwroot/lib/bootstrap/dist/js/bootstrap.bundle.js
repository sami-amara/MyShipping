...
(function (global, factory) {
    ...
    function mapToStyles(_ref2) {
        let _Object$assign2;
        const popper = _ref2.popper, popperRect = _ref2.popperRect, placement = _ref2.placement, variation = _ref2.variation, offsets = _ref2.offsets, position = _ref2.position, gpuAcceleration = _ref2.gpuAcceleration, adaptive = _ref2.adaptive, roundOffsets = _ref2.roundOffsets, isFixed = _ref2.isFixed;
    ...
    function isScrollParent(element) {
        ...
        const _getComputedStyle = getComputedStyle$1(element), overflow = _getComputedStyle.overflow, overflowX = _getComputedStyle.overflowX, overflowY = _getComputedStyle.overflowY;
    ...
    */
    ...
    function computeOffsets(_ref) {
        const reference = _ref.reference, element = _ref.element, placement = _ref.placement;
    ...
    function offset(_ref2) {
        ...
        const _options$offset = options.offset, offset = _options$offset === void 0 ? [0, 0] : _options$offset;
        ...
        return function createPopper(reference, popper, options) {
            ...
            var instance = {
                ...
                forceUpdate: function forceUpdate() {
                    ...
                    const _state$elements = state.elements, reference = _state$elements.reference, popper = _state$elements.popper; // Don't proceed if `reference` or `popper` are not valid elements
                    // anymore
                    ...
                    for (let index = 0; index < state.orderedModifiers.length; index++) {
                        ...
                        const _state$orderedModifie = state.orderedModifiers[index], fn = _state$orderedModifie.fn, _state$orderedModifie2 = _state$orderedModifie.options, _options = _state$orderedModifie2 === void 0 ? {} : _state$orderedModifie2, name = _state$orderedModifie.name;
            ...
            function runModifierEffects() {
                state.orderedModifiers.forEach(function (_ref) {
                    const name = _ref.name, _ref$options = _ref.options, options = _ref$options === void 0 ? {} : _ref$options, effect = _ref.effect;
