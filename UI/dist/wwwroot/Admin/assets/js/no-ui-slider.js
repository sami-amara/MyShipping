(function ($) {
    ...
    if ($('#value-range').length) {
        const bigValueSlider = document.getElementById('value-range'), bigValueSpan = document.getElementById('huge-value');
    ...
    if ($('#skipstep-connect').length) {
        $(function () {
            const skipSlider = document.getElementById('skipstep-connect');
            noUiSlider.create(skipSlider, {
                connect: true,
                range: {
                    'min': 0,
    ...
    if ($('#skipstep-connect-3').length) {
        $(function () {
            const skipSlider = document.getElementById('skipstep-connect-3');
            noUiSlider.create(skipSlider, {
                connect: true,
                range: {
                    'min': 0,
...
//# sourceMappingURL=no-ui-slider.js.map