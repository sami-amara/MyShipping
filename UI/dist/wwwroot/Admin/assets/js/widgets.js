(function ($) {
    'use strict';
    $(function () {
        const infoColor = '#2b8ae3';
        const primaryColor = '#b76cf8';
        const secondaryColor = '#c3bdbd';
        const successColor = '#5bcfb5';
        const dangerColor = '#ef7a95';
        const warningColor = '#fbd84a';
        ...
        if ($('#conversionBarChart').length) {
            const barChartCanvas = $('#conversionBarChart').get(0).getContext('2d');
