(function () {
    ...
    const DeactivateAccount = {
        ...
        init: function () {
            ...
            if (button.length === 0) {
                if (this.config.debug)
                    console.warn('❌ Deactivate button not found:', this.config.buttonId);
                return;
            }
        ...
        showDeactivationConfirmation: function () {
            ...
            showAlert.Confirm('⚠️ Permanently Deactivate Account?', `<p>This action is <strong>PERMANENT</strong> and <strong>CANNOT</strong> be undone.</p>
                 ...
                 <p><strong>This action is logged for compliance.</strong></p>`, '❌ Yes, Deactivate My Account', (result) => this.onConfirmationResult(result));
        },
        /**
