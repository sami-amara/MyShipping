...
window.FormValidator = (function () {
    ...
    function showError(input, message) {
        ...
        const backendSpan = parent ? Array.from(parent.querySelectorAll('.text-danger')).find(el => !el.classList.contains('field-error-message') && el.textContent.trim() === message) : null;
        if (backendSpan)
            backendSpan.style.display = 'none';
    }
    ...
    function attach(formSelector, rules) {
        ...
        form.addEventListener('submit', function (e) {
            ...
            if (!isValid) {
                ...
                if (firstError && ((_a = window.ScrollHelper) === null || _a === void 0 ? void 0 : _a.scrollToCenter)) {
