...
(function (factory) {
    ...
    $.jstree.core.prototype = {
        ...
        _append_json_data: function (dom, data, cb, force_processing) {
            ...
            }, inst = this, func = function (data, undefined) {
                if (data.data) {
                    data = data.data;
                }
         ...
         * @name toggle_icons()
         */
        toggle_ellipsis: function () { if (this._data.core.themes.ellipsis) {
            this.hide_ellipsis();
        }
        else {
            this.show_ellipsis();
    ...
    $.jstree.plugins.checkbox = function (options, parent) {
        ...
        this._cascade_new_checked_state = function (id, checkedState) {
            ...
            if ((this.settings.checkbox.cascade_to_disabled || !node.state.disabled) &&
            ...
            stop: function (e) {
                ...
                if (vakata_dnd.is_drag) {
                    ...
                    if (e.type === "touchend" && e.target === vakata_dnd.target) {
                        ...
                        $(e.target).one('click', function () { if (to) {
                            clearTimeout(to);
                        } });
                    }
                }
    ...
    $.jstree.plugins.massload = function (options, parent) {
        ...
        this._load_node = function (obj, callback) {
            ...
            if (data) {
                rslt = this[typeof data === 'string' ? '_append_html_data' : '_append_json_data'](obj, typeof data === 'string' ? $($.parseHTML(data)).filter(function () { return this.nodeType !== 3; }) : data, function (status) { callback.call(this, status); });
