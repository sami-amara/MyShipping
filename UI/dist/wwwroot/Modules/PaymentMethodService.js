(function () {
    ...
    svc.GetPaymentDetails = function (paymentMethodId, shippingRate) {
        return new Promise((resolve, reject) => {
            ...
            svc.GetById(paymentMethodId, function (response) {
                const paymentMethod = (response === null || response === void 0 ? void 0 : response.data) || (response === null || response === void 0 ? void 0 : response.Data) || response;
                if (!paymentMethod) {
                    reject(new Error('Payment method not found'));
                    return;
                }
                // Calculate total with commission
                svc.CalculateTotal(paymentMethodId, shippingRate, function (totalResponse) {
                    const total = (totalResponse === null || totalResponse === void 0 ? void 0 : totalResponse.data) || (totalResponse === null || totalResponse === void 0 ? void 0 : totalResponse.Data) || totalResponse;
                    resolve({
