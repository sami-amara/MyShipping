...
(function () {
    ...
    $(document).ready(function () {
        ...
        if (params.get('created') === '1') {
            showSuccessAlert(alerts.createdTitle || 'Shipment Created', alerts.createdSuccess || 'Shipment created successfully');
            cleanUrl();
        }
        if (params.get('updated') === '1') {
            showSuccessAlert(alerts.updatedTitle || 'Updated', alerts.updatedSuccess || 'Shipment updated successfully');
            cleanUrl();
        }
        if (params.get('deleted') === '1') {
            showSuccessAlert(alerts.deletedTitle || 'Deleted', alerts.deletedSuccess || 'Shipment deleted');
            cleanUrl();
        }
        // ═══════════════════════════════════════════════════════════════
...
//# sourceMappingURL=UserListShipments.js.map