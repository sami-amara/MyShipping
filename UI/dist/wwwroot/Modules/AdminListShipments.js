    ...
    $(document).ready(function () {
        ...
        const showSuccessNotification = () => {
            try {
                ...
                if (!approved && !ready && !shipped && !delivered && !cancelled && !returned && !deleted && !updated)
                    return;
                ...
                if (approved)
                    message = alerts.approvedSuccess || 'Shipment approved successfully';
                else if (ready)
                    message = alerts.readySuccess || 'Shipment marked as ready for shipping successfully';
                else if (shipped)
                    message = alerts.shippedSuccess || 'Shipment marked as shipped successfully';
                else if (delivered)
                    message = alerts.deliveredSuccess || 'Shipment marked as delivered successfully';
                else if (cancelled)
                    message = alerts.cancelledSuccess || 'Shipment cancelled successfully';
                else if (returned)
                    message = alerts.returnedSuccess || 'Shipment marked as returned successfully';
                else if (deleted) {
                ...
                if (itemId) {
                    try {
                        ...
                        if (row) {
                            ...
                            setTimeout(() => {
                                try {
                                    row.classList.remove('flash-approved');
                                }
                                catch (_a) { }
                            }, 3000);
                        }
                ...
                showAlert.ConfirmDelete(function () {
                    ...
                    if (window.ShipmentService && typeof ShipmentService.adminActionsMinimal === 'function') {
                        ShipmentService.adminActionsMinimal(id, {
                            ...
                            const errMsg = err && (err.message || ((_a = err.responseJSON) === null || _a === void 0 ? void 0 : _a.message) || ((_b = err.responseJSON) === null || _b === void 0 ? void 0 : _b.Message)) || (alerts.deleteFailed || 'Unknown error');
                            if (window.showAlert && typeof showAlert.Error === 'function') {
                    ...
                    showAlert.ConfirmDelete(function () {
                        ...
                        if (window.ShipmentService && typeof ShipmentService.adminActionsMinimal === 'function') {
                            ShipmentService.adminActionsMinimal(id, {
                                ...
                                .catch(err => {
                                var _a, _b;
                                const message = err && (err.message || ((_a = err.responseJSON) === null || _a === void 0 ? void 0 : _a.message) || ((_b = err.responseJSON) === null || _b === void 0 ? void 0 : _b.Message)) || (alerts.deleteFailed || 'Failed to delete shipment.');
                                if (window.showAlert && typeof showAlert.Error === 'function') {
...
//# sourceMappingURL=AdminListShipments.js.map