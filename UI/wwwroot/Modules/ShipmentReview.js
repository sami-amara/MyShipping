...
(function () {
    ...
    const ShipmentReview = {
        ...
        validatePaymentMethodSelected_DISABLED: function () {
            ...
            if (!paymentMethodSelect) return false;
        ...
        populateSenderReview: function (form) {
            ...
            const senderName = form.querySelector('[name="SenderName"]')?.value || '';
            const senderEmail = form.querySelector('[name="SenderEmail"]')?.value || '';
            const senderPhone = form.querySelector('[name="SenderPhone"]')?.value || '';
            const senderAddress = form.querySelector('[name="SenderAddress"]')?.value || '';
            const senderCity = form.querySelector('[name="SenderCity"] option:checked')?.text || '';
            const senderPostalCode = form.querySelector('[name="SenderPostalCode"]')?.value || '';
        ...
        populateReceiverReview: function (form) {
            ...
            const receiverEmail = form.querySelector('[name="ReceiverEmail"]')?.value || '';
            const receiverPhone = form.querySelector('[name="ReceiverPhone"]')?.value || '';
            const receiverAddress = form.querySelector('[name="ReceiverAddress"]')?.value || '';
            const receiverCity = form.querySelector('[name="ReceiverCity"] option:checked')?.text || '';
            const receiverPostalCode = form.querySelector('[name="ReceiverPostalCode"]')?.value || '';
        ...
        populatePackageReview: function (form) {
            ...
            const width = form.querySelector('[name="Width"]')?.value || '0';
            const height = form.querySelector('[name="Height"]')?.value || '0';
            const length = form.querySelector('[name="Length"]')?.value || '0';
            const weight = form.querySelector('[name="Weight"]')?.value || '0';
            const packageValue = form.querySelector('[name="PackageValue"]')?.value || '0';
            const packaging = form.querySelector('[name="ShippingPackging"] option:checked')?.text || '';
        ...
        populateShippingReview: function (form) {
            ...
            const shippingType = form.querySelector('[name="ShippingTypes"] option:checked')?.text || '';
            const shippingDate = form.querySelector('[name="ShippingDate"]')?.value || '';
            const deliveryDate = form.querySelector('[name="DelivryDate"]')?.value || '';
        ...
        populateConfirmation: function () {
            ...
            const senderName = form.querySelector('[name="SenderName"]')?.value || naText;
            const receiverName = form.querySelector('[name="ReceiverName"]')?.value || naText;
            const senderCity = form.querySelector('[name="SenderCity"] option:checked')?.text || naText;
            const receiverCity = form.querySelector('[name="ReceiverCity"] option:checked')?.text || naText;
            const shippingType = form.querySelector('[name="ShippingTypes"] option:checked')?.text || naText;
            const weight = form.querySelector('[name="Weight"]')?.value || '0';
            const packageValue = form.querySelector('[name="PackageValue"]')?.value || '0';
        ...
        getFirstInvalidField: function (form) {
            ...
            if (explicitInvalid) return explicitInvalid;
        ...
        jumpToFirstInvalidField: function (form) {
            ...
            const stepIndex = parseInt(fieldset?.getAttribute('data-step') || '0', 10);
