...
const ShipmentService = (function () {
    ...
    const svc = {
        ...
        adminActionsMinimal: function (id, options) {
            ...
            const restoreBtn = function () { if (btn)
                try {
                    btn.disabled = false;
                }
                catch (_a) { } };
        ...
        validatePaymentMethod: function() {
            ...
            const paymentMethodId = paymentMethodField?.value;
            ...
            if (!paymentMethodId || paymentMethodId === '' || paymentMethodId === '00000000-0000-0000-0000-000000000000') {
                ...
                if (validationSpan) {
                    ...
                    const spanNearby = paymentMethodField?.parentElement.querySelector('.text-danger, [class*="validation"]');
                    if (spanNearby) {
        ...
        displayPaymentSummary: function(containerSelector) {
            ...
            if (!form || !container) return Promise.reject(new Error('Form or container not found'));

            const paymentMethodId = form.querySelector('[name="PaymentMethodId"]')?.value;
        ...
        _renderPager: function (paged, tableSelector) {
            ...
            function createLi(text, targetPage, disabled, active) {
                ...
                if (active) {
                    ...
                    a.href = '#';
                    a.textContent = text;
                    a.addEventListener('click', (e) => { e.preventDefault(); if (!disabled)
