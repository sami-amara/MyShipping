...
(function () {
    ...
    const SignalRClient = {
        ...
        // ═══════════════════════════════════════════════════════════
        reconnectWithNewToken: async function () {
            try {
        ...
        // ═══════════════════════════════════════════════════════════
        requestWhoAmI: async function () {
            try {
                if (this.connection && this.connection.state === signalR.HubConnectionState.Connected) {
                    await this.connection.invoke('WhoAmI');
                }
            } catch (error) {
        ...
        // ═══════════════════════════════════════════════════════════
        handleConnectionError: async function (error) {
