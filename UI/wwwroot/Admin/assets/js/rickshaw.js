(function($) {
  ...
  if ($('#rickshaw-simple').length) {
    const rickshawSimple = new Rickshaw.Graph({
  ...
  if ($('#rickshaw-time-scale').length) {
    ...
    const timeScaleGraph = new Rickshaw.Graph({
  ...
  if ($('#rickshaw-bar').length) {
    ...
    const rickshawBar = new Rickshaw.Graph({
  ...
  if ($('#rickshaw-line').length) {
    ...
    const rickshawLine = new Rickshaw.Graph({
  ...
  if ($('#rickshaw-scatter').length) {
    ...
    const rickshawScatter = new Rickshaw.Graph({
  ...
  if ($('#rickshaw-multiple').length) {
    ...
    const rickshawMultiple = new Rickshaw.Graph({
